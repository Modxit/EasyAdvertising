...
while ($r = $modx->db->getRow($res)) {
	...
	$r['published'] = ($r['published'] == 1) ? '<span class="ok">Yes</b>' : '<span class="bad">Нет</span>';
	$r['area'] = ($r['area'] == "") ? '<span class="bad">no</span>' : '<span class="ok">'.$r['area'].'</span>';
	...
	$edit = '<a href="#" title="edit" onclick="addRow('.$r['id'].');return false;"><img src="media/style/MODxCarbon/images/icons/logging.gif" align="absmiddle" /></a>';
	$del = '<a href="#" title="Remove" onclick="if(confirm(\'Are you sure?\')){delRow('.$r['id'].')};return false"><img src="media/style/MODxCarbon/images/icons/delete.png" align="absmiddle" /></a>';
